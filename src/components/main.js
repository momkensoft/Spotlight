              ...
              <div className="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
                <div className="flex flex-col gap-16">
                  <article className="group relative flex flex-col items-start">
                    ...
                    <time
                      className="relative z-10 order-first mb-3 flex items-center text-sm text-zinc-400 dark:text-zinc-500 ltr:pl-3.5 rtl:pr-3.5"
                      datetime="2022-09-05"
                    >
                      <span
                ...
                <div className="space-y-10 ltr:lg:pl-16 ltr:xl:pl-24  rtl:lg:pr-16 rtl:xl:pr-24">
                  <form
                    action="/thank-you"
                  ...
                  >
                    <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                      ...
                      <span className="ltr:ml-3 rtl:mr-3">Stay up to date</span>
                    </h2>
                    ...
                    <div className="mt-6 flex">
                      ...
                      />
                      <button
                        className="inline-flex items-center gap-2 justify-center rounded-md py-2 px-3 text-sm outline-offset-2 transition active:transition-none bg-zinc-800 font-semibold text-zinc-100 hover:bg-zinc-700 active:bg-zinc-800 active:text-zinc-100/70 dark:bg-zinc-700 dark:hover:bg-zinc-600 dark:active:bg-zinc-700 dark:active:text-zinc-100/70 ltr:ml-4 rtl:mr-4 flex-none"
                        type="submit"
                      >
                        Join
                      </button>
                  ...
                  <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
                    <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                      ...
                      <span className="ltr:ml-3 rtl:mr-3">Work</span>
                    </h2>
