                ...
                <li className="flex">
                  <a
                    ...
                    >
                      ...
                      ></path></svg
                    ><span className="ml-4">Follow on Twitter</span></a
                  >
                </li>
                <li className="mt-4 flex">
                  <a
                    ...
                    >
                      ...
                      ></path></svg
                    ><span className="ml-4">Follow on Instagram</span></a
                  >
                </li>
                <li className="mt-4 flex">
                  <a
                    ...
                    >
                      ...
                      ></path></svg
                    ><span className="ml-4">Follow on GitHub</span></a
                  >
                </li>
                <li className="mt-4 flex">
                  <a
                    ...
                    >
                      ...
                      ></path></svg
                    ><span className="ml-4">Follow on LinkedIn</span></a
                  >
                </li>
                <li
                ...
                >
                  <a
                    ...
                    >
                      ...
                      ></path></svg
                    ><span className="ml-4">spencer@planetaria.tech</span></a
                  >
                </li>
              </ul>
            </div>
