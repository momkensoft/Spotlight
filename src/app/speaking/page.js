            ...
            <div className="mx-auto max-w-2xl lg:max-w-5xl">
              <header className="max-w-2xl">
                ...
                <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                  One of my favorite ways to share my ideas is live on stage,
                  where there’s so much more communication bandwidth than there
                  is in writing, and I love podcast interviews because they give
                  me the opportunity to answer questions instead of just present
                  my opinions.
                </p>
              </header>
                      ...
                      <div className="md:col-span-3">
                        <div className="space-y-16">
                          ...
                          <article className="group relative flex flex-col items-start">
                            ...
                            <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                              They say that if you’re not embarassed by your
                              first version, you’re doing it wrong. Well when
                              you’re selling DIY space shuttle kits it turns out
                      ...
                      <div className="md:col-span-3">
                        <div className="space-y-16">
                          <article className="group relative flex flex-col items-start">
                            ...
                            <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                              How we used world-className visual design to attract a
                              great team, win over customers, and get more press
                              for Planetaria.
                            </p>
                            <div
                              aria-hidden="true"
                          ...
                          <article className="group relative flex flex-col items-start">
                            ...
                            <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                              ...
                              promising space startups in the world without
                              taking any capital from investors.
                            </p>
                            <div
                              aria-hidden="true"
                              className="relative z-10 mt-4 flex items-center text-sm font-medium text-teal-500"
                          ...
                          <article className="group relative flex flex-col items-start">
                            ...
                            <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                              ...
                              everyone on the team knows how to make the right
